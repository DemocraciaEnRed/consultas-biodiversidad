    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='lead-paragraph'>
          ...
          <p>
            <strong> {config.organizationName} es un espacio de diálogo e intercambio</strong> diseñado por la elaboración participativa del <strong>Plan de Acción para la Estrategia Regional para la Conservación de la Biodiversidad de la Región Metropolitana de Santiago.</strong>
          </p>

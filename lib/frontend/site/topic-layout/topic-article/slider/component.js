...
const labels = [
  ...
  [
    ...
    t('proposal-result.high-support'),
      ...
      <div className={`topics-slider ${colored !== false ? colored : 'neutral'}`}>
        {
          showRange && <div className='container-fluid'>
            <div className='input-great-labels'>
              <span>{t('proposal-result.little-against')}</span>
              <span>{t('proposal-result.little-support')}</span>
            </div>
            <InputRange
              maxValue={99}
              minValue={-99}
...
const fillFormatLabel = (value) => {
  const range = {
    ...
    '-66': t('proposal-result.little-against'),
    '-33': t('proposal-result.middle-against'),
    '0': t('proposal-result.neutral'),
    '33': t('proposal-result.little-support'),
    '66': t('proposal-result.high-support'),

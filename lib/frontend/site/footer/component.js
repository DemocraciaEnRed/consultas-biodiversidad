            ...
            <div className='logo gob flex-logos'>
              <div className='logo-wrapper sgo'>
                ...
                <div>
                  ...
                  <img src={config.imgs.logoFooter4} />
                </div>
              </div>
              <div className='logo-wrapper colaboracion'>
                <p className='text-uppercase'>Con la colaboración de:</p>
                <div>
                  <img src={config.imgs.logoFooter2} />
                  <img src={config.imgs.logoFooter3} />
                </div>
              </div>
            </div>
          </div>
